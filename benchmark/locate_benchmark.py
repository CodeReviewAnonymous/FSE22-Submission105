...
from networks.locate import LOCATE
...
parser.add_argument("--dataset", type=str, default="Dataset_A", help="Dataset used")
...
model_name = "LOCATE"  # change this name for different models
